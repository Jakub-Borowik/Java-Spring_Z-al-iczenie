...
import pl.diety.diety.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "DISPATCHER") ? "/dispatcher/meal-deliveries" : "/meal-deliveries";
    }
