package pl.ladowarki.ladowarki.config;
...
import pl.ladowarki.ladowarki.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "OPERATOR") ? "/operator/charging-sessions" : "/charging-sessions";
    }
