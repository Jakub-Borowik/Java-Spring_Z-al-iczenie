...
import pl.okna.okna.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "SUPERVISOR") ? "/supervisor/window-cleaning" : "/window-cleaning";
    }
