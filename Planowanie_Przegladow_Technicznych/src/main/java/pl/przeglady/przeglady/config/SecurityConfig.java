package pl.przeglady.przeglady.config;
...
import pl.przeglady.przeglady.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "INSPECTOR") ? "/inspector/inspections" : "/inspections";
    }
