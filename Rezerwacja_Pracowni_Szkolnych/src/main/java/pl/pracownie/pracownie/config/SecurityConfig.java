package pl.pracownie.pracownie.config;
...
import pl.pracownie.pracownie.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "TEACHER") ? "/teacher/school-labs" : "/school-labs";
    }
