package pl.pracownie.pracownie.service;
...
import pl.pracownie.pracownie.repository.LabReservationRepository;
import pl.pracownie.pracownie.repository.SchoolLabRepository;

@Service
@RequiredArgsConstructor
public class LabReservationService {
    private final SchoolLabRepository resourceRepository;
    private final LabReservationRepository recordRepository;
    private final AppUserService appUserService;

    public List<SchoolLab> getAllResources() {
        return resourceRepository.findAll();
    }

    public List<LabReservation> getAllRecords() {
        return recordRepository.findAll();
    }

    public List<LabReservation> getMine() {
        return recordRepository.findByUserId(appUserService.getLoggedInUser().getId());
    }

    public SchoolLab findBestResource(LabType category, int requiredCapacity,
    ...
    @Transactional
    public LabReservation createRecord(LabType category, int requiredCapacity,
            int minQuality, int taskUnits, int priority, LocalDateTime startTime, LocalDateTime endTime) {
        SchoolLab resource = findBestResource(category, requiredCapacity, minQuality,
    ...
    public BigDecimal calculateScore(SchoolLab resource, int requiredCapacity,
    ...
    public BigDecimal calculatePrice(SchoolLab resource, int taskUnits, int priority) {
    ...
    public int calculateRequiredHours(SchoolLab resource, int taskUnits) {
    ...
    private void validateSearch(LabType category, int requiredCapacity,
            int minQuality, int taskUnits, int priority, LocalDateTime startTime, LocalDateTime endTime) {
