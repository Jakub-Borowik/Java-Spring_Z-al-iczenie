package pl.remonty.remonty.config;
...
import pl.remonty.remonty.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "COORDINATOR") ? "/coordinator/renovations" : "/renovations";
    }
