# Przydzial_Ekip_Remontowych

Projekt zaliczeniowy Spring Boot + Vaadin.

- UI klienta: `/renovations`
- Panel roli wyzszej: `/coordinator/renovations`
- Swagger: `/swagger-ui.html`
- REST POST: `/api/renovations`
- Baza PostgreSQL: `przydzial_ekip_remontowych`
- Loginy: `client/client`, `coordinator/coordinator`

## Opis algorytmu

Algorytm wybiera ekipe po typie remontu, metrazu, wymaganej klasie oraz koszcie wykonania. Najpierw waliduje dane: kategorie, wymaganie pojemnosci, minimalna jakosc, liczbe jednostek pracy, priorytet oraz zakres dat.
