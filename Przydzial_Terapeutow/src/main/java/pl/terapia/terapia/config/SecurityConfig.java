package pl.terapia.terapia.config;
...
import pl.terapia.terapia.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "THERAPIST") ? "/therapist/therapy" : "/therapy";
    }
