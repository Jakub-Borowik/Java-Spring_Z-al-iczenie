# Przydzial_Instruktorow_Jazdy

Projekt zaliczeniowy Spring Boot + Vaadin.

- UI klienta: `/driving-lessons`
- Panel roli wyzszej: `/instructor/driving-lessons`
- Swagger: `/swagger-ui.html`
- REST POST: `/api/driving-lessons`
- Baza PostgreSQL: `przydzial_instruktorow_jazdy`
- Loginy: `client/client`, `instructor/instructor`

## Opis algorytmu

Algorytm przydziela instruktora do typu jazdy, poziomu kursanta, doswiadczenia i wolnego terminu. Najpierw waliduje dane: kategorie, wymaganie pojemnosci, minimalna jakosc, liczbe jednostek pracy, priorytet oraz zakres dat.
