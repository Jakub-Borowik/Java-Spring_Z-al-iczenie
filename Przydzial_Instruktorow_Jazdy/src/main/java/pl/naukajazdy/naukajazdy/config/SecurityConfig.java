package pl.naukajazdy.naukajazdy.config;
...
import pl.naukajazdy.naukajazdy.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "INSTRUCTOR") ? "/instructor/driving-lessons" : "/driving-lessons";
    }
