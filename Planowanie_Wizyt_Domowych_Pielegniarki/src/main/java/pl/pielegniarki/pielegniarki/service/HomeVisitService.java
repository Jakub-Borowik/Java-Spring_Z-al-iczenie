package pl.pielegniarki.pielegniarki.service;
...
public class HomeVisitService {
    private final NurseTeamRepository resourceRepository;
    private final HomeVisitRepository recordRepository;
    private final AppUserService appUserService;

    public List<NurseTeam> getAllResources() {
        return resourceRepository.findAll();
    }

    public List<HomeVisit> getAllRecords() {
        return recordRepository.findAll();
    }

    public List<HomeVisit> getMine() {
        return recordRepository.findByUserId(appUserService.getLoggedInUser().getId());
    }

    public NurseTeam findBestResource(CareType category, int requiredCapacity,
    ...
    @Transactional
    public HomeVisit createRecord(CareType category, int requiredCapacity,
            int minQuality, int taskUnits, int priority, LocalDateTime startTime, LocalDateTime endTime) {
        NurseTeam resource = findBestResource(category, requiredCapacity, minQuality,
    ...
    public BigDecimal calculateScore(NurseTeam resource, int requiredCapacity,
    ...
    public BigDecimal calculatePrice(NurseTeam resource, int taskUnits, int priority) {
    ...
    public int calculateRequiredHours(NurseTeam resource, int taskUnits) {
