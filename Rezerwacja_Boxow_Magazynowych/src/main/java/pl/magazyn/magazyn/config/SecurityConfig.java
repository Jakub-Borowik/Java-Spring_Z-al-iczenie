package pl.magazyn.magazyn.config;
...
import pl.magazyn.magazyn.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "WAREHOUSE") ? "/warehouse/storage" : "/storage";
    }
