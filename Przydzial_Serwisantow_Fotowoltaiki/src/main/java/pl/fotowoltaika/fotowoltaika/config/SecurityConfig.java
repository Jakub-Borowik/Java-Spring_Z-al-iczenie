package pl.fotowoltaika.fotowoltaika.config;
...
import pl.fotowoltaika.fotowoltaika.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "TECHNICIAN") ? "/technician/solar-services" : "/solar-services";
    }
