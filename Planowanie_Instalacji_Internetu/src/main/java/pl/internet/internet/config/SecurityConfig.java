package pl.internet.internet.config;
...
import pl.internet.internet.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "TECHNICIAN") ? "/technician/internet-installations" : "/internet-installations";
    }
