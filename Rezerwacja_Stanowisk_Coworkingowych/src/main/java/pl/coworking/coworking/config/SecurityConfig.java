package pl.coworking.coworking.config;
...
import pl.coworking.coworking.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "MANAGER") ? "/manager/coworking-bookings" : "/coworking-bookings";
    }
