package pl.klimatyzacja.klimatyzacja.config;
...
import pl.klimatyzacja.klimatyzacja.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "TECHNICIAN") ? "/technician/ac-services" : "/ac-services";
    }
