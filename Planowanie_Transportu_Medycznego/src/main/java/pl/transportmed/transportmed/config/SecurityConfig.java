package pl.transportmed.transportmed.config;
...
import pl.transportmed.transportmed.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "DISPATCHER") ? "/dispatcher/medical-transport" : "/medical-transport";
    }
