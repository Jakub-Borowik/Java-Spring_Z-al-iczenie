# Planowanie_Transportu_Medycznego

Projekt zaliczeniowy Spring Boot + Vaadin.

- UI klienta: `/medical-transport`
- Panel roli wyzszej: `/dispatcher/medical-transport`
- Swagger: `/swagger-ui.html`
- REST POST: `/api/medical-transport`
- Baza PostgreSQL: `planowanie_transportu_medycznego`
- Loginy: `client/client`, `dispatcher/dispatcher`

## Opis algorytmu

Algorytm wybiera pojazd medyczny po typie transportu, standardzie, trasie i pilnosci. Najpierw waliduje dane: kategorie, wymaganie pojemnosci, minimalna jakosc, liczbe jednostek pracy, priorytet oraz zakres dat.
