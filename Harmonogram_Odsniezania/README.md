# Harmonogram_Odsniezania

Projekt zaliczeniowy Spring Boot + Vaadin.

- UI klienta: `/snow-removal`
- Panel roli wyzszej: `/dispatcher/snow-removal`
- Swagger: `/swagger-ui.html`
- REST POST: `/api/snow-removal`
- Baza PostgreSQL: `harmonogram_odsniezania`
- Loginy: `client/client`, `dispatcher/dispatcher`

## Opis algorytmu

Algorytm przydziela pojazd do strefy, powierzchni, mocy i czasu wykonania. Najpierw waliduje dane: kategorie, wymaganie pojemnosci, minimalna jakosc, liczbe jednostek pracy, priorytet oraz zakres dat.
