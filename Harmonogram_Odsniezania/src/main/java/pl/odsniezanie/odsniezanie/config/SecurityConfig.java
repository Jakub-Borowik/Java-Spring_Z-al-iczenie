package pl.odsniezanie.odsniezanie.config;
...
import pl.odsniezanie.odsniezanie.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "DISPATCHER") ? "/dispatcher/snow-removal" : "/snow-removal";
    }
