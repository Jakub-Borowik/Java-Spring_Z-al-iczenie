package pl.egzaminy.egzaminy.config;
...
import pl.egzaminy.egzaminy.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "COORDINATOR") ? "/coordinator/exam-rooms" : "/exam-rooms";
    }
