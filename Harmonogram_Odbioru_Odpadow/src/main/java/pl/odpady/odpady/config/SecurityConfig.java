package pl.odpady.odpady.config;
...
import pl.odpady.odpady.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "DISPATCHER") ? "/dispatcher/waste-pickups" : "/waste-pickups";
    }
